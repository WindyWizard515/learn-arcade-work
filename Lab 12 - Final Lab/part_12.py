...
class Player(arcade.Sprite):
    ...
    def on_joybutton_press(self, _joystick, button):
        ...
        if "Button {} down".format(button) == "Button 8 down" or "Button {} down".format(button) == "Button 9 down":
            print("WOWOWOWOW")
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        # Set up the player
        self.player_sprite = Player("/home/paul/learn-arcade-work/Lab 12 - Final Lab/spaceship.gif", SPRITE_SCALING)
